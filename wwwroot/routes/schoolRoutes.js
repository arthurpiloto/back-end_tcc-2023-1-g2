...
const { novoSchool, listarSchools, atualizarSchool, deletarSchool, listarSchoolById, listarSchoolByName } = require('../controllers/schoolController.js')
...
router
    .route('/school/name/:schoolName')
    .get(async (request, response) => {
        let statusCode
        let message

        let name = request.params.schoolName

        if (name != '' && name != undefined) {
            const data = await listarSchoolByName(name)
